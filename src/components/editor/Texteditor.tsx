...
export default function Texteditor({ handleChange, currentDoc, setCurrentDoc }: {handleChange(param1: string, param2: string): void, currentDoc: docInterface, setCurrentDoc(param: docInterface): void} ) {
